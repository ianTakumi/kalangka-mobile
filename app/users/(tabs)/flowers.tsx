...
export default function FlowersScreen() {
  ...
  const handleUpdate = async () => {
    if (updating || isSubmitting || !editingFlower) return;
  ...
  const handleShowFlowerSelector = () => {
    if (flowers.length === 0) {
      Alert.alert(
        "No Flowers",
        "You need to add flowers first before creating fruits from flowers.",
        [
          { text: "Cancel", style: "cancel" },
          { text: "Add Flower", onPress: handleTakePhoto },
        ],
      );
      return;
    }
              ...
              ListEmptyComponent={
                <View className="items-center justify-center py-16">
                  ...
                  <TouchableOpacity
                    ...
                    className="bg-orange-600 px-6 py-3 rounded-xl flex-row items-center"
                  >
            ...
            <View className="flex-1 mr-16">
              ...
              <View className="flex-row items-center mb-1">
                ...
                <Text className="text-sm text-gray-600 ml-1">
                  {new Date(item.wrapped_at).toLocaleString("en-PH")}
                </Text>
              </View>
